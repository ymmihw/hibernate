...
public class ProductSearchDao {
  ...
  public List<Product> searchProductNameByKeywordQuery(String text) {
    ...
    Query keywordQuery =
        getQueryBuilder().keyword().onField("productName").matching(text).createQuery();
  ...
  public List<Product> searchProductNameByFuzzyQuery(String text) {
    ...
    Query fuzzyQuery = getQueryBuilder().keyword().fuzzy().withEditDistanceUpTo(2)
        .withPrefixLength(0).onField("productName").matching(text).createQuery();
  ...
  public List<Product> searchProductNameByWildcardQuery(String text) {
    ...
    Query wildcardQuery =
        getQueryBuilder().keyword().wildcard().onField("productName").matching(text).createQuery();
    @SuppressWarnings("unchecked")
  ...
  public List<Product> searchProductDescriptionByPhraseQuery(String text) {
    ...
    Query phraseQuery =
        getQueryBuilder().phrase().withSlop(1).onField("description").sentence(text).createQuery();
    @SuppressWarnings("unchecked")
  ...
  public List<Product> searchProductNameAndDescriptionBySimpleQueryStringQuery(String text) {
    ...
    Query simpleQueryStringQuery = getQueryBuilder().simpleQueryString()
        .onFields("productName", "description").matching(text).createQuery();
    @SuppressWarnings("unchecked")
  ...
  public List<Product> searchProductNameByRangeQuery(int low, int high) {
    ...
    Query rangeQuery = getQueryBuilder().range().onField("memory").from(low).to(high).createQuery();
    @SuppressWarnings("unchecked")
  ...
  public List<Object[]> searchProductNameByMoreLikeThisQuery(Product entity) {
    ...
    Query moreLikeThisQuery = getQueryBuilder().moreLikeThis().comparingField("productName")
        .toEntity(entity).createQuery();
    @SuppressWarnings("unchecked")
  ...
  public List<Product> searchProductNameAndDescriptionByKeywordQuery(String text) {
    ...
    Query keywordQuery = getQueryBuilder().keyword().onFields("productName", "description")
  ...
  public List<Product> searchProductNameAndDescriptionByCombinedQuery(String manufactorer,
      int memoryLow, int memoryTop, String extraFeature, String exclude) {

    Query combinedQuery = getQueryBuilder().bool()
        .must(
            getQueryBuilder().keyword().onField("productName").matching(manufactorer).createQuery())
        .must(
            getQueryBuilder().range().onField("memory").from(memoryLow).to(memoryTop).createQuery())
        .should(
            getQueryBuilder().phrase().onField("description").sentence(extraFeature).createQuery())
        .must(getQueryBuilder().keyword().onField("productName").matching(exclude).createQuery())
        .not().createQuery();
    @SuppressWarnings("unchecked")
  ...
  private QueryBuilder getQueryBuilder() {
    ...
    return fullTextEntityManager.getSearchFactory().buildQueryBuilder().forEntity(Product.class)
        .get();
  }
}
